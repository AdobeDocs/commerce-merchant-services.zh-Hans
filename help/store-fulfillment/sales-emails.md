...
<tbody><tr>
<td><strong>已启用</strong></td>
<td>此电子邮件将发送给客户，以通知他们在商户商店的订单已被取消。 设置为 <code>No</code> 以禁用电子邮件通知。 如果禁用了电子邮件模板，则此功能不会阻止取消订单。</td>
<td>商店视图</td>
<td>否</td>
</tr>
<tr>
...
<tbody><tr>
<td><strong>已启用</strong></td>
<td>此电子邮件将发送给客户，以通知他们在商户商店中取消了其部分订单。 设置为 <code>No</code> 以禁用电子邮件通知。 如果禁用了电子邮件模板，则不会阻止部分取消订单。</td>
<td>商店视图</td>
<td>否</td>
</tr>
<tr>
...
<td>将发送给指定商家人员的电子邮件作为所有未结订单的汇总报表，这些订单在商家商店库存可用之前无法领料。 </br></br> 商家可以使用此报表来起动和管理商店到商店库存转移或补充。 </br></br>此通知仅适用于 [!DNL Ship-to-Store] 功能已启用。
...
>[!NOTE]
>
>如果您允许延交订单，则必须提供管理员电子邮件地址，以接收有关这些订单的通知。 将地址添加到以下配置设置中： **[!UICONTROL Send Order Delayed Email Copy To]** 在 [订单延迟](#order-delayed) 模板，和 [!UICONTROL Ship To Store Email Recipients] 在 [收货商店](#ship-to-store) 模板。
