...
本指南适用于Adobe Commerce管理员。 它包括有关安装和载入的详细信息 [!DNL Product Recommendations]以及服务的配置和管理。 它假定您对核心有基本的了解 [!DNL Commerce] 配置和功能。
...
* 全部 [!DNL Product Recommendations]特定任务，可在Admin中完成。
...
* [帮助中心](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide.html#submit-tickets){target="_blank"} — 请参阅 [!DNL Product Recommendations] — 相关的故障排除文章。
