...
1. 要禁用 [“稍后付款”消息](payments-options.md#pay-later-button) （如果需要），选择 `No` 对象 **[!UICONTROL Display Pay Later Message]**.
...
| [!UICONTROL PayPal Pay Later Enabled] | 商店视图 | 启用或禁用显示付款按钮的稍后付款选项外观。 选项： [!UICONTROL Yes] / [!UICONTROL No] |
| [!UICONTROL Debug Mode] | 网站 | 启用或禁用“调试模式”。 选项： [!UICONTROL Yes] / [!UICONTROL No] |
